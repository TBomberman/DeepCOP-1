...
def do_validation(data, labels, model_file_prefix):
    ...
    labels = utils.to_categorical(labels_class, nb_classes)
...
def load_and_validate():
    ...
    for target_cell_name in target_cell_names:
        file_suffix = target_cell_name + '_covid'
        ...
        npY = np.load(load_data_folder_path + file_suffix + "_Y.npz")['arr_0']
        do_validation(npX, npY, model_file_prefix)
